...
const ProductDetailsAnalysisSection = ({ product }) => {
  return (
    <section>
      <Stack direction={{ sm: 'column', lg: 'row' }} spacing={2}>
        <>
          <ProductAnalysisCardOne product={product} />
          <Hidden only={['lg', 'xl']}>
            <p style={{ fontSize: '12px', color: '#7A797D' }}>
              Designed for users to instantly see the changes that occur on the SKU and predicts
              what will come next.
            </p>
          </Hidden>
        </>
