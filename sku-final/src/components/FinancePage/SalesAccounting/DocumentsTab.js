...
const columns = [
  ...
  {
    field: 'userPaymentId',
    headerName: 'User Sales Payment ID',
    width: 200,
    sortable: false,
    filterable: false,
    disableColumnMenu: true,
...
export const FILTER_OPTIONS = [
  { label: 'All', value: 'All' },
  { label: 'Order Invoice', value: 'Order Invoice' },
  { label: 'Order Referral Fees Bill', value: 'Order Referral Fees Bill' },
  { label: 'VAT & Tax Payables', value: 'VAT & Tax Payables' },
];
