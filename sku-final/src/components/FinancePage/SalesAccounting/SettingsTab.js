            ...
            <Stack direction="row" spacing={2} sx={{ mb: 2 }}>
              ...
              <Stack direction="row" spacing={2}>
                ...
                <Stack>
                  ...
                  You will be paid on the 1st of each week. if your balance has positive amount and more than SAR 1000 we will transfer it, you will be charged automatically for referral fees and VAT & Taxes Payable...{' '}
                    <Link component={RouterLink} to="/help_center" underline="none">
                      Learn more.
                    </Link>
                  </Typography>
