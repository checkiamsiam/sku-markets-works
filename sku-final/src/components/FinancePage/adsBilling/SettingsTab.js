...
import MonthlySpendDetails from './MonthlySpendDetails';
      ...
      <Box>
        <div ref={ref}>
          ...
          >
            ...
            >
              <Stack width="100%" direction="row" justifyContent="space-between">
                <Typography sx={{ color: '#3366FF' }}>Monthly Spend Limit</Typography>
              </Stack>
            </AccordionSummary>
            <AccordionDetails>
              <MonthlySpendDetails />
          ...
          >
            ...
            >
              <Stack width="100%" direction="row" justifyContent="space-between">
                <Typography sx={{ color: '#3366FF' }}>Ads Management Users</Typography>
