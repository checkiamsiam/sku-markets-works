...
import SkuCategoryProduct from './SkuCategoryProduct';

const SponsoredInDetail = () => {
      ...
      <Card sx={{ p: 2, my: 2 }}>
        ...
        >
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            <AnimatedGradiantText>Sponsored SKUs</AnimatedGradiantText>
          </Box>
...
export default SponsoredInDetail;
