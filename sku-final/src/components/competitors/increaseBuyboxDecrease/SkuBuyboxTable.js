...
import BuyboxDataGrid from './BuyboxDataGrid';
...
const SkuBuyboxTable = () => {
 /*  const { brand } = useParams();
  ...
  return (
    <>
      <Card sx={{ mt: 3 }} >
        <CardHeader title="SKUs not selling" sx={{ mb: 1.5 }} />
        <Box sx={{ height: 470 }}>
          <BuyboxDataGrid data={_dataGrid} />
        </Box>
      </Card>
