...
const logic = 'sort=-price_updated_at';
const fields = 'id,sku_marketplace,sku,current_price,all_images,brand_en,category_en,price_change';

const MostVolatileTable = () => {
    ...
    return (
        <>
            <Card>
                <CardHeader title="Most Volatile" sx={{ mb: 2 }} />
                <Box sx={{ height: 500 }}>
                    <ThemeDataGrid
                        page={page}
                        setPage={setPage}
...
export default MostVolatileTable;
