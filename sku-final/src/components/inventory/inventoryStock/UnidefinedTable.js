...
import UnidefinedDataGrid from './UnidefinedDataGrid';

const UnidefinedTable = () => {
 /*  const { brand } = useParams();
  ...
  return (
    <>
      <Card sx={{ mt: 3 }} >
        <CardHeader title="Stock- Inbound/ Unidentified" sx={{ mb: 1.5 }} />
        <Box sx={{ height: 450 }}>
          <UnidefinedDataGrid data={[]} />
        </Box>
      </Card>
...
export default UnidefinedTable;
