...
const logic = 'is_live=true';
const fields =
  'id,sku_marketplace,sku,current_price,all_images,brand_en,category_en,price_change,sold_24_hours,estimated_SOH';
