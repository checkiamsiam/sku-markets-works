        ...
        <Grid container spacing={2}>
          ...
          <Grid item container direction="column" spacing={0}>
              ...
              <Typography component={Link} to={`/skuMarket/${1}`}variant="caption" sx={{textDecoration:"none", color:'text.primary'}}>
                ...
                <Typography component={Link} to={`/brand/${"sonai"}`} variant="caption" sx={{textDecoration:"none",color:'text.primary'}}>
                  Sonai
                </Typography>
                <br />
                <Typography component={Link} to={`/category/${"home & kitchen"}`} variant="caption"  sx={{textDecoration:"none",color:'text.primary'}}>
                  Home & Kitchen
                </Typography>
              </Grid>
              <Grid item>
          ...
          <Grid item xs={6} md={2} container>
            <Grid item md alignItems="center" container direction="column" spacing={1} >
              ...
              <Typography variant="caption" sx={{ fontSize: '12px', fontWeight:600, p:0 }}>Order Referral Fees </Typography>
