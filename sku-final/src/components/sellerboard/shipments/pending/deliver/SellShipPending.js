  ...
  return (
    <>
            ...
            <Stack item container direction="column" spacing={0}>
              ...
              <Grid item>
                <Stack direction="row" spacing={1}>
                  ...
                  <Divider orientation="vertical" variant="middle" flexItem />
                  <Link
                    to={`https://google.com/maps/@${1.111},${0.255},20z`}
                    target="_blank"
                    rel="noreffer"
                  >
      ...
      <CancelAlert
        ...
        item={''}
        alert={'Are you sure you want to cancel this Shipment Pending'}
        title={'Shipment Pending Cancel'}
        btnTitle={'Cancel'}
        text={'Shipment Pending Cancelled Successfully'}
      />
      ...
      <ShippedAlert
        ...
        item={''}
        alert={'Are you sure you want to shipped this Shipment Pending'}
        title={'Shipment Pending Shipped'}
        btnTitle={'Shipped'}
        childTitle={'Shipment Number (AWB)'}
        text={'Shipment Pending Shipped Successfully'}
