  ...
  return (
    <>
      ...
      <CancelAlert
        ...
        item={''}
        alert={'Are you sure you want to cancel this packed of Shipment Pending'}
        title={'Shipment Pending packed Cancel'}
        btnTitle={'Cancel'}
        text={'Shipment Pending packed Cancelled Successfully'}
      />
      <ShippedAlert
        delivered={false}
        open={openAccept}
        ...
        item={''}
        alert={'Are you sure you want to packed this Shipment Pending'}
        title={'Shipment Pending packed'}
        btnTitle={'packed'}
        childTitle={'Shipment Number (AWB)'}
        text={'Shipment Pending packed Successfully'}
