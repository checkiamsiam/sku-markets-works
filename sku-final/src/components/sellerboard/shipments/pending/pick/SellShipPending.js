...
const SellShipPending = ({ shipment, buyer, refetch }) => {
  ...
  return (
    <>
            ...
            <Stack item container direction="column" spacing={0}>
              ...
              <Grid item>
                <Typography variant="caption">
                  ...
                  {shipment?.payment?.orders?.length} items
                </Typography>{' '}
              </Grid>
              <Grid item>
                <Typography variant="caption">
                  <span style={{ fontWeight: 700 }}>Total Quantity:</span>{' '}
                  {shipment?.payment?.totalQty} units
                </Typography>{' '}
              </Grid>
      ...
      <CancelAlert
        ...
        item={''}
        alert={'Are you sure you want to cancel this picked of Shipment Pending'}
        title={'Shipment Pending picked Cancel'}
        btnTitle={'Cancel'}
        text={'Shipment Pending picked Cancelled Successfully'}
      />
      <ShippedAlert
        delivered={false}
        open={openAccept}
        ...
        item={''}
        alert={'Are you sure you want to picked this Shipment Pending'}
        title={'Shipment Pending picked'}
        btnTitle={'picked'}
        childTitle={'Shipment Number (AWB)'}
        text={'Shipment Pending picked Successfully'}
        shipment={shipment}
        refetch={refetch}
      />
    </>
...
export default SellShipPending;
