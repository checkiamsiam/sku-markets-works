  ...
  return (
    <>
            ...
            <Stack item container direction="column" spacing={0}>
              <Grid item>
                <Typography variant="caption">
                  <span style={{ fontWeight: 700 }}>RTV Shipment (AWB) Number:</span> 85858575875FD
                </Typography>
              </Grid>
              <Grid item>
                <Typography variant="caption">
      ...
      <ConfirmationAlert
        ...
        item={''}
        alert={'Are you sure you want to confirm this RTV '}
        title={'RTV Confirm'}
        btnTitle={'Confirm'}
        text={'RTV Confirmed Successfully'}
      />
    </>
  );
};

export default SellRTV;
