...
const BottomBanner = ({ categories, isLoading, isFetching }) => {
        ...
        {categories?.map((category, i) => (
          <SwiperSlide key={i}>
            ...
            >
              ...
              >
                <img
                  src={category.products[0]?.product?.all_images[0]}
                  alt=""
              ...
              >
                <Link
                  to={`/skuMarket?marketplace=${encodeURIComponent(category?.sku_marketplace)}`}
                >
                  <img
