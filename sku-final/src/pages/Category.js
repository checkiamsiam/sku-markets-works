...
import BranCards from 'components/category/BrandCard';
import CategoryTable from 'components/category/CategoryTable';
import CetegoryChart from 'components/chart/CetegoryChart';
...
export default function Category() {
    ...
    const { data } = useAnalyticsByCategoryQuery(category);
