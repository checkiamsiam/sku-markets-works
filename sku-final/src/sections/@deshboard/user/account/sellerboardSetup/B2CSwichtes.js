...
const ORDERS_OPTION = [
  { value: 'RequestsNew', label: 'Requests New' },
  { value: 'RequestsReview', label: 'Requests Review' },
];
const PAYMENT_OPTION = [{ value: 'PaymentPending', label: 'Payment Pending' }];
...
export default function B2CSwichtes() {
  ...
  const defaultValues = {
    ...
    RequestsNew: B2B_CONTROL_SETTINGS.RequestsNew,
    RequestsReview: B2B_CONTROL_SETTINGS.RequestsReview,
    PaymentPending: B2B_CONTROL_SETTINGS.PaymentPending,
  };
      ...
      <Card ref={ref} sx={{ p: 2, mt: 3 }}>
        ...
        >
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography sx={{ width: '33%', flexShrink: 0, color: '#3366FF' }}>Order</Typography>
        ...
        >
          ...
          <AccordionDetails>
            <Box sx={{ px: 2 }}>
              ...
              <Stack alignItems="flex-start" spacing={1} sx={{ mt: 2, mb: 5 }}>
                {PAYMENT_OPTION.map((application) => (
                  <RHFSwitch
                    key={application.value}
                    name={application.value}
                    label={application.label}
