...
import OrderAccordions from './BottomCard/OrderAccordions';
import RetrurningAccordions from './BottomCard/Returing';
import ShipmentPreparing from './BottomCard/shipmentPreparing';
import Shipping from './BottomCard/Shipping';
const BottomCard = () => {
  return (
    <Card sx={{ p: 2, overflow: 'visible', mt: 3 }}>
      <Typography variant="subtitle1" sx={{ pb: 2 }}>
        B2C SellerBoard Flow Setup
      </Typography>
